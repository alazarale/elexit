...
class _StoreScreenState extends State<StoreScreen> {
  ...
  getData() async {
    ...
    if (store_exam != null) {
      int cc = 0;
      store_exam!
          .removeWhere((item) => code.contains('cd${item.id.toString()}'));
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.pushNamed(context, '/store-national',
                              arguments: {'where': 'all'});
                        },
                        child: Card(
                          shape: RoundedRectangleBorder(
                      ...
                      child: GestureDetector(
                        ...
                        child: SizedBox(
                          ...
                          child: Card(
                            ...
                            child: Container(
                              foregroundDecoration: store_exam?[index].isNew ==
                                      'no'
                                  ? null
                                        ...
                                        PopupMenuButton(
                                          itemBuilder: (context) {
                                            return [
                                              PopupMenuItem(
                                                value: 'buy',
                                                child: Text("BUY  ${store_exam![index].price} ETB"),
                                              ),
                                            ];
                                          },
