        ...
        actions: [
          StatefulBuilder(
            builder: (context, setState) {
              return Switch(
                value: Provider.of<RefData>(context).isDarkMode,
                onChanged: (value) {
                  setState(() {
                    Provider.of<RefData>(context, listen: false).setDarkMode(value);
                  });
                },
              );
            },
                                  ...
                                  children: [
                                    ...
                                    _lan == 'am'
                                        ? const Padding(
                                            ...
                                            child: Center(
                                              child: Text(
                                                'በአንድ ግዜ የሰብስክሪብሽን ክፍያ መተግበሪያው ላይ የሚገኙትን ፊተናዎች በሙሉ ያለ ተጨማሪ ክፍያ ይጠቀሙ። በውስጡ የብዙ አመታት የሀገር አቀፍ የ12 ኢንትራንስ ፈተና ፣ ሞዴል ፈተና እና በተለያዩ ግዜያት የሚዘጋጁ መልመጃዎች ይይዛል።',
                                                style: TextStyle(
                                                  color: Color.fromARGB(
                                                      255, 220, 220, 220),
                                                  fontSize: 16,
                                        ...
                                        : const Padding(
                                            ...
                                            child: Center(
                                              child: Text(
                                                'By paying a one time subscription fee, get all Exams on the APP without any additional fee. Within the APP, you will find previous year Entrance Exams and Model Exams.',
                                                style: TextStyle(
                                                  color: Color.fromARGB(
                                                      255, 220, 220, 220),
                                                  fontSize: 16,
