...
class _HomePageState extends State<HomePage> {
  ...
  dbstat() async {
    ...
    if (!exists) {
      ...
      // Copy from asset
      ByteData data = await rootBundle.load(Path.join("assets", "elexam.db"));
      ...
      child: Column(
        children: [
          ...
          CarouselSlider.builder(
            ...
            itemCount: exams.length < 4 ? exams.length : 4,
            itemBuilder:
                (
                                        ...
                                        ? ElevatedButton(
                                          onPressed: () {
                                            AwesomeDialog(
                                              ...
                                              title: "Taking Exam",
                                              desc:
                                                  'You are taking ${exams[itemIndex].name}. Time given is ${exams[itemIndex].time} minutes. Some of the questions might have images associated with them and needs internet access to load the images. So for the questions with "(Image)" key word infront of them, make sure you are connected to load the images.',
          ...
          Row(
            ...
            children: [
              Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.pushNamed(context, '/random', arguments: {});
                  },
                  child: Card(
              ...
              child: Column(
                children: [
                  ...
                  GridView.builder(
                    ...
                    itemCount: exams.length > 4 ? 4 : exams.length,
                                                ...
                                                ? ElevatedButton(
                                                  onPressed: () {
                                                    AwesomeDialog(
                                                      ...
                                                      title: "Taking Exam",
                                                      desc:
                                                          'You are taking ${exams[index].name}. Time given is ${exams[index].time} minutes. Some of the questions might have images associated with them and needs internet access to load the images. So for the questions with "(Image)" key word infront of them, make sure you are connected to load the images.',
