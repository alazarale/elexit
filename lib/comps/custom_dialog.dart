...
class _CustomDialogBoxState extends State<CustomDialogBox> {
  ...
  paying() {
    ...
    Provider.of<RefData>(
      context,
      listen: false,
    ).saveCredintial(first_name.text, last_name.text, email.text);
    print(ref_no);
    Chapa.paymentParameters(
      context: context, // context
      publicKey: 'CHASECK-f3omIRwQ1Am2yiLQqvZ15AOnvNjjgHI9',
      currency: 'ETB',
      amount: '${widget.price}',
      email: email.text,
      phone: '0911111111',
      ...
      title: 'title',
      desc: 'desc',
      namedRouteFallBack: '/paid', // fall back route name
    );
    setState(() {
      isloading = false;
    });
